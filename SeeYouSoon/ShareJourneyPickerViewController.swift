...
class ShareJourneyPickerViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        shareJourneyButton.layer.borderColor = UIColor(red: 0.93, green: 0.95, blue: 0.95, alpha: 1.0).cgColor
        shareJourneyButton.layer.borderWidth = 1
        shareJourneyButton.layer.cornerRadius = 10
